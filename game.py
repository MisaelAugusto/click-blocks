...
time_bonus_sound = pygame.mixer.Sound("1.ogg")
click_sound = pygame.mixer.Sound("2.ogg")
seconds_sound = pygame.mixer.Sound("3.ogg")
test_sound = pygame.mixer.Sound("4.ogg")
main_sound = pygame.mixer.Sound("main.ogg")

# Images

Block_pink = pygame.image.load("Block_Pink.png")
Block_blue = pygame.image.load("Block_Blue.png")
Timer_aux = pygame.image.load("Time_aux.png")
Selected_block = pygame.image.load("selected.png")
Unselected_block = pygame.image.load("unselected.png")
Timer_bonus = pygame.image.load("timer_bonus.png")
Time_bonus_aux = pygame.image.load("Time_bonus_aux.png")
